          ...
          {mode !== "forgot" && (
            <div className="mb-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 rounded-lg border border-border bg-muted px-4 py-3 font-body text-sm text-foreground hover:bg-accent transition-colors"
              >
