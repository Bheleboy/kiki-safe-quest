...
const bookLinks = [
  {
    name: "Amazon",
    url: "https://www.amazon.com.br/Kikis-Armour-English-Nonala-Dagada-ebook/dp/B0FBX2XS3H",
    icon: (
  ...
  {
    name: "Apple Books",
    url: "https://books.apple.com/us/book/kikis-armour-of-god/id6745028928",
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
  ...
  {
    name: "Kobo",
    url: "https://www.kobo.com/my/en/ebook/kiki-s-armour-of-god?srsltid=AfmBOoqvK_TjSdiDbibLAheuxUT98Yv1thfGO9L9CyQCPFTp7dzdENP4",
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
  ...
  {
    name: "Barnes & Noble",
    url: "https://www.barnesandnoble.com/w/kikis-armour-of-god-nonala-tose-dagada/1147336266",
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
